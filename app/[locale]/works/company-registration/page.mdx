<Cover
  src="https://res.cloudinary.com/hazelsuh-site/image/upload/Frame_427321250_taty9w.png"
  alt="Image from the movie Alien - from cosmos.com"
  caption="ZUZU 회사 등록"
/>

## 법인 운영 관리를 위한 회사 등록 플로우 개선

기투자자 기반 브로커(추천인) 시스템 설계
Public 딜 페이지 생성 및 VC 가입 유도
